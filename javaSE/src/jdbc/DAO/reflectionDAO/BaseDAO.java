...
public abstract class BaseDAO<T> {
    private Class<T> classReflect = null;
    {
        //所有子类实例化的时候都会调用这个代码块
        Type genericSuperclass = this.getClass().getGenericSuperclass();
        ParameterizedType parameterizedType =  (ParameterizedType) genericSuperclass;
        Type[] actualTypeArguments = parameterizedType.getActualTypeArguments();
        classReflect = (Class<T>) actualTypeArguments[0];
    }
    ...
    //适用于事务的通用增删改操作
    public void commonIDU(Connection connection, String sql, Object... args)  {
    ...
    public List<T> GeneralQueryPreparedSatement(Connection connection,  String sql, Object... args){
        PreparedStatement preparedStatement = null;
