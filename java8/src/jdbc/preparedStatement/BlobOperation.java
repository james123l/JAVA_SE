...
public class BlobOperation {
    ...
    public static void blobInsert()  {
        ...
        try {
            ...
            //文件流
            //默认当前工程目录,即最大的根目录
            FileInputStream inputStream = new FileInputStream(new File("\\java8\\src\\jdbc\\BlobMaterial\\02.jpg"));
    ...
    public static void bolbUpdate()  {
        ...
        try {
            ...
            inputStream = new FileInputStream(new File("\\java8\\src\\jdbc\\BlobMaterial\\04.jpg"));
