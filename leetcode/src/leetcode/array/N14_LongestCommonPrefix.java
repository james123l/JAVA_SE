...
public class N14_LongestCommonPrefix {
    ...
    public static void main(String[] args) {
        N14_LongestCommonPrefix n14LongestCommonPrefix = new N14_LongestCommonPrefix();
        System.out.println(n14LongestCommonPrefix.longestCommonPrefix02(new String[]{"flower", "flow", "flight"}));
    }
